// ── SPOTIFY — bouton minimaliste ──────────────────────────────────────────────
// Un seul bouton "Ouvrir Spotify". Ouvre l'app native, fallback web.
...
export function initSpotify() {
  ...
  if (!container) return;
  container.innerHTML = `
    <button class="sp-btn-open" onclick="import('./js/spotify.js').then(m=>m.openSpotify())">
